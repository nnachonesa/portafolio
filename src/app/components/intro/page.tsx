  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl">
        <h1 className="text-3xl font-bold mb-4">yo, simplemente yo, nacho.</h1>
        ...
        <p className="text-base mb-4 font-mono">
          ...
          resolver problemas y explorar nuevas cosas. Mi lenguaje de preferencia
          es TypeScript, aunque siempre estoy aprendiendo{" "}
        ...
        <p className="text-base mb-4 font-mono">
          ...
          , con el objetivo de generar conexiones y seguir creciendo en el mundo
          de la programación.
        </p>
      </div>
